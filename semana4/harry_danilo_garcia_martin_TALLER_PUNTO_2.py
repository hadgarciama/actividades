'''
AyudanteNomina v2.0b
Programa para calcular la nomina de una empresa. Lee los nombres y salarios desde un archivo de texto cuyo nombre se ingresa como argumento en la linea de comandos.
...
contenido_linea = "'Nombre ''completo '*'Salario_Base'|'Auxilio_Transporte'|'Cesantias*'Interese'*'Prima'|'Arl'*'Salud_empresa'*'Pension_empresa'|'Salud_empleado'*'Pension_empleado*'Fondo_solidaridad'|'costo_para_empresa'|Salario_neto\n"
