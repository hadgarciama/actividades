'''
AyudanteNomina v2.0c
Programa para calcular la nomina de una empresa. Lee los nombres y salarios desde un archivo de texto cuyo nombre se ingresa como argumento en la linea de comandos. Al final del programa, imprime el contenido del archivo de liquidacion.
...
def imprimir_array_liquidacion(array_a_imprimir):
	for x in range(0,len(array_a_imprimir)):
		print array_a_imprimir[x]
def imprimir_archivo_liquidacion(nombre_archivo):
	array_archivo_liquidacion = open(nombre_archivo, 'r')
	print('\n Este es el contenido del archivo de liquidacion \n ')
	print(array_archivo_liquidacion.read())
	array_archivo_liquidacion.close()
