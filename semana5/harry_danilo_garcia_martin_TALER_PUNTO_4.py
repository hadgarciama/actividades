'''
AyudanteNomina v2.0d
Programa para calcular la nomina de una empresa. Lee los nombres, salarios y cargos desde un archivo de texto cuyo nombre se ingresa como argumento en la linea de comandos.Luego suma la nomina total de la empresa y suma la nomina por cargos.
...
#convertir las variables de suma en str para poderlas escribir en el archivo de liquidacion
